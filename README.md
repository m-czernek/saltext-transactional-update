# Salt Extension for Transactional Update

Salt Extension for operating systems with Transactional Update
...
The saltext-transactional-update project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:m-czernek/saltext-transactional-update.git

# Change to the repo dir
cd saltext-transactional-update
```
...
* Writing blog posts
* Sharing your experiences using Salt + Transactional Update
  on social media
...
[PRs]: https://github.com/m-czernek/saltext-transactional-update/pulls
[discussions]: https://github.com/m-czernek/saltext-transactional-update/discussions
